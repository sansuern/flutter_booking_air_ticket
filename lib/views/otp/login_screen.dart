  ...
  Future<void> signInWithPhoneNumber(String phoneNumber) async {
    ...
    await auth.verifyPhoneNumber(
      ...
      verificationCompleted: (PhoneAuthCredential credential) async {
        ...
        print("verify success $credential");
      },
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: _buildSocialLogo('assets/images/facebook.png'),
                  ),
                  SizedBox(width: 40),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: _buildSocialLogo('assets/images/apple.png'),
                  ),
                  SizedBox(width: 40),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: _buildSocialLogo('assets/images/google.png'),
                  ),
                ],
              ),
            ],
